    ...
    async loadSystemInfo() {
        try {
            ...
            this.services = [
                ...
                { id: 'object', name: 'Object Detection', url: `http://${this.localIP}:5005`, port: 5005, status: false },
    ...
    showService(serviceId) {
        ...
        const clickedTab = Array.from(document.querySelectorAll('.nav-tab'))
            .find(tab => {
                ...
                if (serviceId === 'object') return tabText.includes('object');
